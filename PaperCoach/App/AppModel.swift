...
final class AppModel {
    ...
    /// Onboarding is over: remember it, and open the lesson it ended on — the
    /// player takes over the cover from onboarding, with no Home in between — or,
    /// without one, show Home.
