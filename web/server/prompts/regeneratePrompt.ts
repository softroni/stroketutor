...
const INTRO = `You improve pen-and-ink drawing lessons for StrokeTutor. Adults who never learned to draw copy each step onto real paper with a pen, one step at a time, while a phone animates that step.
