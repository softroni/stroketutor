# Paper Couch iOS — design brief for the screen agents

You are designing one part of the Paper Couch iOS learner app as an interactive HTML mockup with developer notes.
...
Paper Couch is a guided *physical* sketching system for adult beginners, especially people around 40 and older who
