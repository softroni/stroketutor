# StrokeTutor iOS · v3 screens — brief for the screen agents

You are redesigning one group of screens of the StrokeTutor iOS learner app as an interactive HTML mockup with short
